  ...
  const fetchKuliner = async () => {
    try {
      ...
      setFormData({
        ...
        hargaMin: data.hargaMin?.toString() || "",
        hargaMax: data.hargaMax?.toString() || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.error || "Gagal mengupdate kuliner");
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-800">Edit Kuliner</h1>
          <p className="text-slate-600 mt-1">Edit informasi tempat kuliner</p>
        </div>
        <button
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            initialLocation={
              formData.koordinat
                ? {
                    ...
                    lon: parseFloat(formData.koordinat.split(",")[1]),
                  }
                : undefined
            }
          />
        ...
        <div className="flex justify-end gap-4">
          ...
          >
            {loading ? "Menyimpan..." : "Update Kuliner"}
          </button>
        </div>
      </form>
    </div>
